...
![script editor](https://files.lowtechguys.com/cling-script-editor-setting.png)

- **File preview** panel alongside the results, on by default and toggled with `⌘⇧P`
    - Play and scrub video and audio, scroll PDFs and text, and pinch to zoom images, all inline
